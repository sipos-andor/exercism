...
public class TriangleTests
{
    ...
    [Fact]
    public void Degenerate_triangle_sum_of_the_lengths_of_two_sides_equals()
    {
        Assert.True(Triangle.IsDegenerate(1, 1, 0));
    }

    [Fact]
    public void Degenerate_triangle_sum_of_the_lengths_of_two_sides_does_not_equal()
    {
        Assert.False(Triangle.IsDegenerate(1, 1, 1));
    }

    [Fact]
    public void Degenerate_triangle_sides_may_be_floats()
    {
        Assert.True(Triangle.IsDegenerate(0.5, 0.0, 0.5));
    }
