...
{
    [Fact]
    public void Black_and_brown_and_black()
    {
        Assert.Equal("1 ohm", ResistorColorTrio.Label(new[] { "black", "brown", "black" }));
    }
    ...
    [Fact]
    public void Brown_and_black_and_red()
    {
        Assert.Equal("1 kiloohm", ResistorColorTrio.Label(new[] { "brown", "black", "red" }));
    }

    [Fact]
    public void Black_and_brown_and_orange()
    {
        Assert.Equal("1 kiloohm", ResistorColorTrio.Label(new[] { "black", "brown", "orange" }));
    }
